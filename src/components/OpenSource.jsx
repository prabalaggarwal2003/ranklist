...
const OpenSource = () => {
  ...
  return (
    <div className="p-4 sm:p-12 mt-4 sm:mt-12">
      {/* Header & Filters */}
      <div className="flex flex-col sm:flex-row sm:justify-between gap-4 mb-6">
        <h1 className="text-xl sm:text-2xl text-white font-bold">Open Source Leaderboard</h1>
          ...
          filteredData.map((user, idx) => (
            ...
            >
              <div className="flex justify-between items-start mb-3">
                ...
                <div className="text-xl font-bold text-blue-400">#{idx + 1}</div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-3 text-sm">
                ...
                <div>
                  <span className="text-gray-400">Batch:</span> {user.year}
                </div>
                <div>
                  <span className="text-gray-400">⭐ Stars:</span> {user.stars}
                </div>
                <div>
                  <span className="text-gray-400">📦 Repos:</span> {user.publicRepos}
                </div>
                <div>
                  <span className="text-gray-400">🔀 PRs:</span> {user.mergedPRs}
                </div>
                <div>
                  <span className="text-gray-400">🤝 Contributed:</span> {user.reposContributed}
                </div>
              </div>
