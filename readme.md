...
Frontend: ReactJS with Tailwind CSS for responsive, component-based UI​

Backend/Data: Google Sheets API for real-time data management​

Deployment: Vercel for scalable cloud hosting with global CDN​

Installation
Web Version
Access the live application at: http://ranklist.bpitindia.com

Install as Mobile App (Android) using link below:
[📱 Download APK](https://github.com/aryanpillai103/ranklist/releases/download/v1.0.0/BPIT.Leaderboard.apk)
